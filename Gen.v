 ...
 intros n X v l. 
  ...
  Case "l = h :: l'".
    ...
    SCase "n = O".
      inversion eq.
    SCase "n = S n'". 
      assert (length (snoc l' v) = S n) as H.
      apply IHl'.
      inversion eq.
      reflexivity.
      rewrite H.
...
Theorem len1 : forall (X:Type) (n:X) (l1 l2:list X),
